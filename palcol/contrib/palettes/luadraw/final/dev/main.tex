...
% copy and paste the file ''palette-def.lua'' into the folder
% ''contrib/palettes/luadraw/final'', giving it a name using the
% ''UpperCamelCase'' format.
%
% warning::
%     Use luadraw colors and do not change the variable name
%     ''PALETTE''.
%
% note::
%     The ''author'' field at the beginning of the file may be
%     omitted.
%%%

\begin{filecontents*}[overwrite]{palette-def.lua}
...
\showlua{palette-def.lua}


\section*{Use cases}

\directlua{dofile('core/drawsurf-z-bary.lua')}
\directlua{dofile('core/colormap.lua')}
\directlua{dofile("palette-def.lua")}
