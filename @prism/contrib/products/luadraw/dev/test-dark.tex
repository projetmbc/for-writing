...
PALETTE = {LightCyan,LightSkyBlue,Plum,LightCoral,LightSalmon,Khaki,PaleGreen}
\end{filecontents*}
...
\begin{luadraw}{name = level-curve-surface}
...
\begin{luadraw}{name = nerftiti-z-bary}
