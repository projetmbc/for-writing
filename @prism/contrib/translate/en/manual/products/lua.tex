...
The \tdoccodein{lua}+getPal+ function provides several options to easily build new palettes by transforming existing ones. To illustrate how this works, consider the following use case.
