...
\begin{tdoccaut}
The current version of {\LUADRAW} simply uses the palettes provided by {\thisproj}. If you prefer to use the {\thisproj} version with its \tdoccodein{lua}+getPal+ function, you will need to include the entire code in the {\LUADRAW} file where the package is installed.
\end{tdoccaut}
