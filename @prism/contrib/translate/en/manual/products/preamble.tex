...
The \tdoccodein{text}+JSON+ product allows unsupported programming languages to integrate {\thisproj} palettes easily. Palettes are defined as shown in the following example.
