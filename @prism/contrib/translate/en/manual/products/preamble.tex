...
All implementations are in the \tdoccodein{text}+products+ folder. Each implementation provides at least the palette definitions. When supported, you can do the following actions.
