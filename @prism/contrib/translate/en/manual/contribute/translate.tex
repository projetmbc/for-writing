...
\subsubsection{The status folder}
...
\subsubsection{The README.md and LICENCE.txt files}
...
\emph{\textbf{Let's say you want to add support for Italian.}}%
\footnote{
...
\begin{enumerate}
    ...
    Do not use the \verb#main# branch, which is used to freeze the latest stable versions of all the projects in the mono repository \thismonorepo.

    \item In the \verb#@prism/contrib/translate# folder, create an \verb#it# copy of the \verb#en# folder, where \verb#it# is the short name of the language documented in
