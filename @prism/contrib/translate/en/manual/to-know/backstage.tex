...
We give below the palettes ignored because they created a duplicate.%
\footnote{
    Remember that \matplotlib\ reversed color maps are ignored (their name hase \tdoccodein{py}{_r} suffix). So we do not show this initially ignored palettes.
}
The symbol \boxed{{=}\vphantom{pM}} means \tdocquote{is equal to} and \boxed{{\rightleftharpoons}\vphantom{pM}} means \tdocquote{is reverse of}, and the right most palette is the one kept inside \thisproj.
%
