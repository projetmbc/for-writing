...
\begin{tdocnote}
  ...
  \smallskip
  \input{../graphics/spectrum-reversed.luadraw}

  \tdoccodein{lua}{getPal('GeoRainbow', {reverse = true})}

  \smallskip
  \input{../graphics/spectrum-shift.luadraw}

  \tdoccodein{lua}{getPal('GeoRainbow', {shift = 6})}

  \smallskip
  \input{../graphics/spectrum-extract.luadraw}
