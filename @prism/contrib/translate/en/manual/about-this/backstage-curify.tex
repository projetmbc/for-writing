...
\begin{itemize}
    ...
    \item \textbf{No sub-sequences.}
    Palettes derived by removing colors from an existing palette while preserving their original order are ignored.

    \item \textbf{No derived versions.}
    Palettes that can be reconstructed through any combination of slicing, shifting, or reversal are omitted. Most implementations provide an API to perform these transformations dynamically via parameters.
