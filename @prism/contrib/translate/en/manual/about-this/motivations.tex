...
\begin{center}
    \subimport{../../../common/graphics/}{surface.luadraw}
\end{center}
...
\begin{tdocnote}
    ...
    %
    \begin{center}
        \subimport{../../../common/graphics/}{palette-reversed.luadraw}

        \tdoccodein{lua}+getPal('GeoRainbow', {reverse = true})+

        \smallskip
        \subimport{../../../common/graphics/}{palette-shift.luadraw}

        \tdoccodein{lua}+getPal('GeoRainbow', {shift = 3})+

        \smallskip
        \subimport{../../../common/graphics/}{palette-extract.luadraw}
    ...
    %
    \begin{center}
        \subimport{../../../common/graphics/}{surface-options.luadraw}
    \end{center}
\end{tdocnote}
