...
\begin{itemize}
    ...
    Palettes that can be reconstructed through a combination of shifting and reversal are omitted. Most implementations provide an API to perform these transformations dynamically via parameters.
