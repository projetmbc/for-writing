...
% AUTO CATEGOS - START
  ...
  2/{Two-color palettes -- 79 palettes},%
  3/{Three-color palettes -- 93 palettes},%
  4/{Four-color palettes -- 33 palettes},%
  5/{Smooth palettes -- 19 palettes},%
  6/{Semantic palettes -- 34 palettes}%
% AUTO CATEGOS - END
}{
  \ifthenelse{\nb = 1}{}{\newpage}
