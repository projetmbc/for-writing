...
Many of the discrete color palettes in this project are based on colormaps from [`Colorbrewer`](https://colorbrewer2.org), [`Matplotlib`](https://colorbrewer2.org) and [`Scientific Coulour Maps`](https://www.fabiocrameri.ch/colourmaps).
