...
\begin{luadraw}{name = check-palette-\PALETTE-dark}
local g = graph:new{
...
\begin{luadraw}{name = check-spectrum-\PALETTE-dark}
-- Let's work!
local g = graph:new{
  window = {xmin, xmax, -5, 5},
  bbox   = false
...
\begin{luadraw}{name = check-nefertiti-\PALETTE-dark}
...
\begin{luadraw}{name = check-contour-\PALETTE-dark}
local g = graph:new{
  window = {-1, 6.5, -1.5, 11},
  size   = {16, 14, 0},
  margin = {0, 0, 0, 0},
...
\begin{luadraw}{name = check-level-surface-\PALETTE-dark}
